# Farrowing — standing rulings (current answers only)

**This file outranks every other document in this folder.** The briefs, synthesis
sections and audits are chronological evidence and contain superseded positions; if any
of them disagrees with a line here, this line wins. One line per ruling, no history —
...
- **Receipt copy (owner, 2026-09-01):** `N saved · +X new` / `N saved · −X new` — save
  language, one word for the visit. The `saved hh:mm · who`
